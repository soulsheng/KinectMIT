...
#include "opengles.h"
#endif
static UINT NEAR MESSAGEPRE=RegisterWindowMessage("MESSAGEPRE");
static UINT NEAR MESSAGENES=RegisterWindowMessage("MESSAGENES");
static UINT NEAR MESSAGELAS=RegisterWindowMessage("MESSAGELAS");

static UINT NEAR MESSAGEUP=RegisterWindowMessage("MESSAGEUP");
static UINT NEAR MESSAGEDOWN=RegisterWindowMessage("MESSAGEDOWN");
static UINT NEAR MESSAGELEFT=RegisterWindowMessage("MESSAGELEFT");
static UINT NEAR MESSAGERIGHT=RegisterWindowMessage("MESSAGERIGHT");
...
void XnVPointDrawer::OnPointCreate(const XnVHandPointContext* cxt)
{
	...
	m_ptSum=m_ptSum+1;
	m_ptNum=m_ptNum+1;
	m_ptSumRotate=m_ptSumRotate+1;
	m_ptNumRotate=m_ptNumRotate+1;
